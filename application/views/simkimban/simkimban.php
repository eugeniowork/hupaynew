...
<div class="div-main-body simkimban">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="d-flex flex-column justify-content-center">
                <button class="btn btn-success" data-toggle="modal" data-target="#addEmployeeToSimkimbanModal">Add Employee with SIMKIMBAN</button>
            </div>
    ...
    <div class="modal fade" id="addEmployeeToSimkimbanModal" tabindex="-1" role="dialog" aria-labelledby="addEmployeeToSimkimbanModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addEmployeeToSimkimbanModalLongTitle">Add Employee with SIMKIMBAN</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <span>Items</span>
                            <input type="text" class="form-control add-item" placeholder="Enter item">
                        </div>
                        <div class="col-lg-4">
                            <span>Amount Loan</span>
                    ...
                    <br/>
                    <div class="add-simkimban-warning">
                        
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary add-simkimban-btn">Submit</button>
                </div>
            </div>
        </div>
    </div>
