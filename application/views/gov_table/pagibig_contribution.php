...
<div class="div-main-body" >
	...
	<div class="div-main-body-content ">
        ...
        <?php endif ?>
		<table class="table table-striped table-bordered" id="pagibigContributionList">
            <thead>
                <tr>
...
<script src="<?php echo base_url();?>assets/js/gov_table/pagibig_contribution.js"></script>